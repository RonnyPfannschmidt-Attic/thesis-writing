...
\dhitem[S2]
  Alle anfallenden längerfristig verfügbaren Daten sollen\\
...
Wie in \Cref{fig:use-case-muss} gut zu erkennen,
...
Auch bei den Arten der Arbeitsschritte gibt es für gew\"ohnlich mehrere M\"oglichkeiten (siehe Kapitel~\ref{chap:ist-analyse}).
...
Die erste Erweiterung betrachtet vergleichende Analysen von Testergebnisen \deffeat{ext-testing}.
...
\begin{description}
  ...
  \dhitem[Beispiel Datenanalyse]
    soll die Funktion der Beispielerweiterung f\"ur die Datenanalyse sicherstellen
\end{description}
