...
Sind diese dann angelegt, mann man damit beginnen, Auftr\"age abzusetzen \deffeat{auftrag-absetzen}.
Ist ein Auftrag abgesetzt, so muss seine Richtigkeit sichergestellt werden \deffeat{auftrag-validieren},
danach kann er f\"ur die Bearbeitung \deffeat{auftrag-vorbereiten} vorbereitet werden.

Nach dem der Auftrag an sich vorbereitet ist, m\"ussen entsprechend der Build-Matrix \deffeat{auftrag-matrix}
Arbeitspackete generiert werden \deffeat{arbeitspacket-generieren}.
Diese Arbeitspackete werden anschliesend verteilt \deffeat{arbeitspacket-verteilen} und abgearbeitet \deffeat{arbeitspacket-abarbeiten}.

Das Abarbeiten der Arbeitspackete sollte in Schritten erfolgen \deffeat{arbeitspackete-schritte},
wobei die grundlegendste Art von Arbeitsschritt das Ausf\"uhren eines Prozesses \deffeat{arbeitsschritt-prozess} ist.
...
Somit sind einige Themen, welche f\"ur ein produktiv eingesetztes CI-System Notwendig
sind Aussen vor.
