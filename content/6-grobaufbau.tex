...
Dies kann je nach Methode in mehrere Schritte umfassen.
...
\begin{description}
    ...
    \dhitem[HTTP Hook]
        ...
        Sie sind einfach in externe Werkzeuge, wie z.B. \ac{SCM} integrierbar,
...
Die Zuteilung von Arbeitspaketen is ein komplexes Thema.
...
Dieses Unterkapitel beschäftigt sich mit der Zuteilung von Arbeitspaketen.
...
Dieses Unterkapitel behandelt einige Ansätze zum Zugriff auf die Daten in der verteilten Datenbank.
...
Dies ist der Grund, warum der ``ProcessProc''-Datentyp einen
...
Dieses Unterkapitel beschäftigt sich mit dem Aufbau der zwei Beispielerweiterungen.
...
Um die Eigenschaften und Möglichkeiten dieses Systems zu praktisch zu ergründen, ist es notwendig, das Kernsystem vollständig zu implementieren.
