...
\begin{description}
    ...
    \dhitem[Aktualisierung des Arbeitsverzeichniss]
        Die Aktualisierung des Arbeitsverzeichnisses bringt die Dateien im Arbeitsverzeichniss auf eine gewünschte Version.
    \dhitem[Anwendung von Patches]
        Die Anwendung von Patches wendet Patches auf das aktuelle Arbeitsverzeichniss an.
\end{description}
