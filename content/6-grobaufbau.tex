...
Dabei Fallen zur Laufzeit sammelbare Daten wie z.B. Text auf den standard Eingabe-/Ausgabe Datenstr\"omen
an.
...
\begin{description}
    ...
    \dhitem[Aktualisierung des Arbeitsverzeichniss]
        ...
        auf eine/die gew\"unschte Version
...
Erweiterte Versionen dieeses Schrittes, k\"onnten zus\"atzliche Funktionen,
